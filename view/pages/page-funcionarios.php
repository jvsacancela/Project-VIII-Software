 ...
 <?php include ('../includes/sidebar.php')?>
    ...
    <div id="contenido-page">
      <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
        <div class="d-flex align-items-center">
          ...
          <h3 class="fs-2 m-0">Funcionarios</h3>
        </div>
    ...
    <div class="container-fluid px-4">
        ...
        <div class="row my-5 col-md-11 m-auto">
          ...
          <div>
            <hr>
            <a class="col-sm-2" id="btnAdd" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="icon ion-md-pulse"></i>Nuevo funcionario</a>
